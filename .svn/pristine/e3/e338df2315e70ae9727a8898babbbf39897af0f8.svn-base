...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%d successful, %d skipped, timeElasped %.2f)", (int)total - (int)self.skippedCount, (int)self.skippedCount, CFAbsoluteTimeGetCurrent() - self.startedTime);
}
